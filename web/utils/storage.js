 ...
 * @return {void|Promise} 
 */
export function setStorage(key = '', data = {}, isSync = true) {
  if(isSync) {
 ...
 */
export function getStorage(key = '', isSync = true) {
  if (isSync) {
 ...
 * @return {void|Promise} 
 */
export function removeStorage(key = '', isSync = true) {
  if (isSync) {
 ...
 * @return {void|Promise} 
 */
export function clearStorage(isSync = true) {
  if (isSync) {
 ...
 */
export function getStorageInfo(isSync = true) {
  if (isSync) {
